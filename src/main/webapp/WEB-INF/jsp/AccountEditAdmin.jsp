...
<body>
<div class="container">
<form:form action="/UserManagement/EditAccountAdmin" method="post" modelAttribute="AccountEntity">
    ...
    <form:password class="form-control" value="Passwor2" path="pword" cssStyle="display:none"/> <br/>
