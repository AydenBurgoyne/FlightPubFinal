...
<div class="container">
    ...
    <form action="${pageContext.request.contextPath}/Journey/BookingHandlingIndividual" id="form" method="GET">
    <table class="table"> .
        ...
        <tr id="selectionTemplate">
            ...
            <td>
                <select class="form-control purchaseType" name="hasReserved">
...
<script>
    ...
    $(document).ready(function () {
        ...
        $("#form").submit(function (event) {
            ...
            if($(".purchaseType").size() === 1){
                generateNotification($("#submit"),"Please select a seat");
                event.preventDefault();
                return
            }

            sessionStorage.setItem("bookingType","Individual");
        });
